 ...
 */
void DisorderModelTransition::ZZ_time_corr_component_init_(AllPara const & parameters) {
 ...
 */
void DisorderModelTransition::ZZ_time_corr_component_compute_(AllPara const & parameters,
                                                              const EvolOP* model,
 ...
 */
void DisorderModelTransition::ZZ_time_corr_component_out_(AllPara const & parameters, const string& name) {
