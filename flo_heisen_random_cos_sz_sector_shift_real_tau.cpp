...
/**
 ** Implementation of FloEvolHeisenRandomCosSzSectorShiftRealTau class
 **/
 ...
 */
void FloEvolHeisenRandomCosSzSectorShiftRealTau::Repr_Init_(){
    repr_ << "Heisen_Random_Cos_Sz_Sector_Shift_Real_Tau_Floquet_L=" << size_ << ",h=" << h_ << ",tau=" << tau_;
    type_ = "Heisen_Random_Cos_Sz_Sector_Shift_Real_Tau_Floquet";
}

/*
 * Initialize random numbers
 */
void FloEvolHeisenRandomCosSzSectorShiftRealTau::Evol_Para_Init() {
 ...
 * Copy random numbers
 */
void FloEvolHeisenRandomCosSzSectorShiftRealTau::Evol_Para_Copy(const vector< vector<double> >& random_h) {
    random_h_.resize(size_);
 ...
 */
void FloEvolHeisenRandomCosSzSectorShiftRealTau::Dim_Cal_() {
...
void FloEvolHeisenRandomCosSzSectorShiftRealTau::Spin_Config_() {
 ...
 */
void FloEvolHeisenRandomCosSzSectorShiftRealTau::Evol_Construct() {
 ...
 */
void FloEvolHeisenRandomCosSzSectorShiftRealTau::Evol_X_Z_Construct_(MatrixXcd& evol_half_x, MatrixXcd& evol_z) {
 ...
 */
void FloEvolHeisenRandomCosSzSectorShiftRealTau::Get_Ham(MatrixXcd& ham, string basis, string s) const {
