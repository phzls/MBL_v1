...
//===================================================================================
    ...
    parameters.transition.flo_transition_compute["ZZ_All_Correlation_Square"] = false; // zz correlation square
    // at all distances
...
//============================================================================================
    ...
    parameters.linked_cluster_para.linked_cluster_cal["Average_Entropy"] = true;
