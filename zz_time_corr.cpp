 ...
 */
void DisorderModelTransition::ZZ_time_corr_init_(AllPara const & parameters) {
 ...
 */
void DisorderModelTransition::ZZ_time_corr_compute_(AllPara const & parameters,
                                                    const EvolOP* model,
 ...
 */
void DisorderModelTransition::ZZ_time_corr_out_(AllPara const & parameters, const string& name) {
