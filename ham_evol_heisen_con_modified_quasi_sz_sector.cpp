...
/**
 ** Implementation of HamEvolHeisenConModifiedQuasiSzSector class
 **/
 ...
 */
void HamEvolHeisenConModifiedQuasiSzSector::Repr_Init_(){
    repr_ << "Heisen_Con_Modified_Quasi_Sz_Sector_Hamiltonian_L=" << size_ << ",h=" << h_
          << ",Sz_" << total_spin_z_;
    type_ = "Heisen_Con_Modified_Quasi_Sz_Sector_Hamiltonian";
}

/*
 * Initialize random numbers
 */
void HamEvolHeisenConModifiedQuasiSzSector::Evol_Para_Init() {
 ...
 */
void HamEvolHeisenConModifiedQuasiSzSector::Dim_Cal_() {
...
void HamEvolHeisenConModifiedQuasiSzSector::Spin_Config_() {
 ...
 */
void HamEvolHeisenConModifiedQuasiSzSector::Evol_Construct() {
