...
/*
 * Implementation of FloEvolIsingQuasiSimpCosReal class
 */
 ...
 */
void FloEvolIsingRandomSimpShiftCosReal::Evol_Para_Init() {
 ...
 * Copy random numbers
 */
void FloEvolIsingRandomSimpShiftCosReal::Evol_Para_Copy(const vector< vector<double> >& random_h) {
    random_h_.resize(size_);
 ...
 */
void FloEvolIsingRandomSimpShiftCosReal::Evol_Construct() {
 ...
 */
void FloEvolIsingRandomSimpShiftCosReal::Evol_X_Construct_(MatrixXcd & evol_half_x) {
 ...
 */
void FloEvolIsingRandomSimpShiftCosReal::Evol_Z_Construct_(MatrixXcd & evol_z) {
    for (int i=0; i<dim_;i++){
