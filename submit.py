...
def adroit_submit(data, program_name, count, exe_folder = None):
    T = fp.RunTime()
    ...
    submit_program_name = fp.slurm_file_gen(data, T, count, exe_folder)
...
def feynman_submit(data, program_name, count, exe_folder = None):
    T = fp.RunTime()
    # Obtain estimated running time
    non_neg = False
    ...
    # Generate submitting files
    submit_program_name = fp.qsub_file_gen(data, T, count, exe_folder)
