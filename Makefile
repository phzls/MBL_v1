...
tasks = disorder_transition.o single_model_time_evolution.o state_evol.o
...
single_model_evolution = init_obj.o evol_data.o random_pure_init.o product_random_init.o random_product_init.o entropy_per_model.o
