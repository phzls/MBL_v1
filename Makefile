...
linked_cluster = linked_cluster_class.o cluster_ave_ent.o

controls = tasks_models.o model_func.o

small_methods = matrix_algebra.o screen_output.o mersenne.o evec_to_basic.o reduced_density_left_2.o generic_func.o combinatorics.o disorder_transition_func.o state_entropy_left_2.o model_entropy_left_2.o model_para_generation.o

transitions = basis_transition.o basic_full.o basic_parity.o parity_full.o

para_get = para_read.o para_model_task.o

test_objects = test.o $(models) $(tasks) $(disorder_transition) $(small_methods) $(transitions) $(controls) $(model_evolution) $(op_auto_corr) $(linked_cluster)
mbl_test_objects = main_test.o $(models) $(tasks) $(disorder_transition) $(small_methods) $(transitions) $(controls) $(model_evolution) $(op_auto_corr) $(linked_cluster)
mbl_objects = main.o $(models) $(tasks) $(disorder_transition) $(small_methods) $(transitions) $(controls) $(model_evolution) $(op_auto_corr) $(linked_cluster)
task_model_objects = task_type_print.o $(models) $(tasks) $(disorder_transition) $(small_methods) $(transitions) $(controls) $(model_evolution) $(op_auto_corr) $(linked_cluster)
auto_objects = main_auto.o $(models) $(tasks) $(disorder_transition) $(small_methods) $(transitions) $(controls) $(para_get) $(model_evolution) $(op_auto_corr) $(linked_cluster)
