//
// Created by Liangsheng Zhang on 10/16/15.
//
...
/**
 ** Implementation of HamEvolHeisenConModifiedRandomCosSzSector class
 **/
 ...
 */
void HamEvolHeisenConModifiedRandomCosSzSector::Repr_Init_(){
    repr_ << "Heisen_Con_Modified_Random_Cos_Sz_Sector_Hamiltonian_L=" << size_
          << ",h=" << h_ << ",Sz_" << total_spin_z_;
    type_ = "Heisen_Con_Modified_Random_Cos_Sz_Sector_Hamiltonian";
}

/*
 * Initialize random numbers
 */
void HamEvolHeisenConModifiedRandomCosSzSector::Evol_Para_Init() {
 ...
 */
void HamEvolHeisenConModifiedRandomCosSzSector::Dim_Cal_() {
...
void HamEvolHeisenConModifiedRandomCosSzSector::Spin_Config_() {
 ...
 */
void HamEvolHeisenConModifiedRandomCosSzSector::Evol_Construct() {
    ...
    for(int i=0; i<config_.size(); i++){
        ...
        for(int j=1; j<size_; j++){
            ...
            z_val += (1-alpha_*h_)*spin * prev_spin;
