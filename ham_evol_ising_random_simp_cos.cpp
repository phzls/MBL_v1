 ...
 */
void HamEvolIsingRandomSimpCos::Repr_Init_(){
    repr_ << "Ising_Random_Simp_Cos_Hamiltonian_L=" << size_ << ",W=" << W_;
    type_ = "Ising_Random_Simp_Cos_Hamiltonian";
}

/*
 * Initialize random fields
 */
void HamEvolIsingRandomSimpCos::Evol_Para_Init() {
 ...
 */
void HamEvolIsingRandomSimpCos::Evol_Construct() {
    if(!constructed_){
