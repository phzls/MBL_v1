...
//===================================================================================
    ...
    parameters.generic.model = "XXZ_Uniform_Z_Random_Shift_Real_Flo";
...
//============================================================================================
    ...
    parameters.flo_op_auto_corr.tau_min = 0.8; // Minimum tau
    parameters.flo_op_auto_corr.op_corr_map["Energy"] = true; // Energy autocorrelation
