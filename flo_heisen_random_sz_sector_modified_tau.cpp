...
/**
 ** Implementation of FloEvolHeisenRandomCosSzSectorModifiedTau class
 **/
 ...
 */
void FloEvolHeisenRandomCosSzSectorModifiedTau::Repr_Init_(){
    repr_ << "Heisen_Random_Cos_Sz_Sector_Shift_Modified_Floquet_L=" << size_ << ",h=" << h_ << ",tau=" << tau_;
    type_ = "Heisen_Random_Cos_Sz_Sector_Shift_Modified_Floquet";
}

/*
 * Initialize random numbers
 */
void FloEvolHeisenRandomCosSzSectorModifiedTau::Evol_Para_Init() {
...
void FloEvolHeisenRandomCosSzSectorModifiedTau::Spin_Config_() {
 ...
 */
void FloEvolHeisenRandomCosSzSectorModifiedTau::Evol_Construct() {
...
/*
 * Construct the xx+yy and zz+z parts only for the sector of given total Z spin
 */
void FloEvolHeisenRandomCosSzSectorModifiedTau::Evol_X_Z_Construct_(MatrixXcd& evol_half_x, MatrixXcd& evol_z) {
 ...
 */
void FloEvolHeisenRandomCosSzSectorModifiedTau::Get_Ham(MatrixXcd& ham, string basis, string s) const {
