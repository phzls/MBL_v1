...
/**
 ** Implementation of HamEvolHeisenModifiedQuasiSzSector class
 **/
 ...
 */
void HamEvolHeisenModifiedQuasiSzSector::Repr_Init_(){
    repr_ << "Heisen_Modified_Quasi_Sz_Sector_Hamiltonian_L=" << size_ << ",h=" << h_ << ",Sz_" << total_spin_z_;
    type_ = "Heisen_Modified_Quasi_Sz_Sector_Hamiltonian";
}

/*
 * Initialize random numbers
 */
void HamEvolHeisenModifiedQuasiSzSector::Evol_Para_Init() {
 ...
 */
void HamEvolHeisenModifiedQuasiSzSector::Dim_Cal_() {
...
void HamEvolHeisenModifiedQuasiSzSector::Spin_Config_() {
 ...
 */
void HamEvolHeisenModifiedQuasiSzSector::Evol_Construct() {
