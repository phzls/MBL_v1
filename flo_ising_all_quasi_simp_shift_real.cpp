...
void FloEvolIsingAllQuasiSimpShiftReal::Evol_Para_Init() {
    ...
    if (debug_){
        cout << "Quasi-periodic longitude field phase:  " << h_theta << endl;
        cout << "Longitude field:" << endl;
        for (int i=0; i<size_;i++) cout << random_h_[i] << endl;
        cout << endl;

        cout << "Quasi-periodic NN interaction phase:  " << J_theta << endl;
        cout << "NN interaction:" << endl;
        for (int i=0; i<size_-1;i++) cout << random_J_[i] << endl;
        cout << endl;

        cout << "Quasi-periodic transverse field phase:  " << g_theta << endl;
...
/*
 * Copy quasi-periodic fields. The order must be h, J, g
 */
void FloEvolIsingAllQuasiSimpShiftReal::Evol_Para_Copy(const vector<vector<double> >& fields) {
    random_h_.resize(size_);
    random_J_.resize(size_-1);
    random_g_.resize(size_);
    ...
    if(fields.size() != 1){
        cout << type_ << " has three sets of quasi-periodic fields." << endl;
    ...
    if (debug_){
        cout << "Quasi-periodic longitude field:" << endl;
        for (int i=0; i<size_;i++) cout << random_h_[i] << endl;
        cout << endl;

        cout << "Quasi-periodic NN interaction:" << endl;
        for (int i=0; i<size_-1;i++) cout << random_J_[i] << endl;
        cout << endl;

        cout << "Quasi-periodic transverse field:" << endl;
        for (int i=0; i<size_;i++) cout << random_g_[i] << endl;
        cout << endl;
    }
}
