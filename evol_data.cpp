...
void EvolData::Data_Func_Map_Init_(){
    ...
    // Leftmost Spin Z Per Model data
    string name2 = "Leftmost Spin Z Per Model";
    Data_Init init_func2 = &EvolData::Leftmost_Spin_Z_Per_Model_Init_;
    Data_Cal cal_func2 = &EvolData::Leftmost_Spin_Z_Per_Model_Cal_;
    Data_Cal_C cal_C_func2 = &EvolData::Leftmost_Spin_Z_Per_Model_Cal_C_;
    Data_Out out_func2 = &EvolData::Leftmost_Spin_Z_Per_Model_Out_;
